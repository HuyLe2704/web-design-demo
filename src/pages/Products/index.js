...
import { faChevronDown, faChevronRight, faMinus, faPlus, faTruck } from '@fortawesome/free-solid-svg-icons';
...
function Products() {
    const { value, setValue, handleAddQuantity } = useContext(Context);

    return (
        <div style={{ backgroundColor: '#f5f5f5', paddingTop: '30px', marginTop: '-30px' }}>
            <div className={cx('wrapper', 'container-all', 'd-flex')}>
                <div className={cx('image-items-wrapper')}>
                    <div className={cx('d-flex', 'flex-column')}>
                        <div className={cx('position-relative')}>
                            <div className={cx('position-relative')}>
                                <img
                                    src="https://down-vn.img.susercontent.com/file/sg-11134201-22100-qjppp0pz2uiv5a_tn"
                                    alt=""
                                />
                            </div>
                        </div>
                ...
                <div className={cx('items-info-wrapper')}>
                    <div className={cx('items-info-container')}>
                        <div className={cx('items-info-name-wrapper')}>Yêu thích+</div>
                        <span>Lót chuột cỡ lớn pad chuột freeship chuyên game siêu bền đẹp bảo hành 1 năm Ch2</span>
                    </div>
                    <div className={cx('items-rating-stars-wrapper')}>
                        <button className={cx('items-rating-wrapper')}>
                            <div className={cx('items-rating')}>4.9</div>
                            <div className={cx('stars-wrapper')}>
                                <div className={cx('shopee-rating-stars')}>
                                    <div className={cx('shopee-rating-stars__stars')}>
                                        <div className={cx('shopee-rating-stars-wrapper')}>
                        ...
                        <button className={cx('quantity-rating-wrapper')}>
                            <div className={cx('quantity-rating-quantity')}>842</div>
                            <div className={cx('quantity-rating')}>Đánh giá</div>
                        </button>
                        <div className={cx('sold-wrapper')} tabIndex={0}>
                            <div className={cx('sold-quantity')}>3,1k</div>
                            ...
                            <div className={cx('flash-sale-wrapper')}>
                                <div className={cx('d-flex', 'align-items-center')}>
                                    ...
                                    <div className={cx('flash-sale-price-section')}>
                                        <div className={cx('flash-sale-price-wrapper')}>₫20.000 - ₫70.000</div>
                                        <div className={cx('d-flex', 'align-items-center')}>
                                            <div className={cx('flash-sale-price-new-price')}>₫15.000 - ₫44.000</div>
                                ...
                                >
                                    ...
                                    <div className={cx('flash-sale-time-discount')}>BẮT ĐẦU SAU 15:00, 4 Th12</div>
                                    <FontAwesomeIcon
                                        icon={faChevronRight}
                        ...
                        <div className={cx('d-flex', 'flex-column')}>
                            <div className={cx('shopee-shop-discount-wrapper')} tabIndex={0}>
                                <div className={cx('shopee-mini-vouchers')}>
                                    <h3 className={cx('shopee-mini-vouchers__label')}>Mã giảm giá của Shop</h3>
                                    ...
                                    <div className={cx('shopee-transpot')}>
                                        ...
                                        <div className={cx('shopee-transpot-location-wrapper')}>
                                            <div className={cx('shopee-transpot-location')}>
                                                ...
                                                <div
                                                    className={cx('d-flex', 'align-items-center', 'position-relative')}
                                                >
                                                    <div className={cx('d-flex', 'align-items-center')}>
                                            ...
                                            <div className={cx('d-flex', 'align-items-center')}>
                                                <div className={cx('transpot-price-label')}>phí vận chuyển</div>
                                                <div>
                                ...
                                <div className={cx('d-flex', 'align-items-center')}>
                                    <div style={{ marginRight: '15px' }}>
                                        <div className={cx('shopee-input-quantity')}>
                                            <Button className={cx('shopee-input-quantity-btn')}>
