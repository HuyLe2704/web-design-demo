...
const RecomendItems = (props) => {
    ...
    useEffect(() => {
        if (!moreItems || moreItems.length === 0) {
            setItemsToShow(suggestItems);
        }
    }, [suggestItems, moreItems]);
                                            ...
                                            <div className={cx('border-shopee-black9', 'bg-white')}>
                                                <div className={cx('flex-column', 'd-flex')}>
                                                    <div className={cx('shopee_itemcard__panel')}>
                                                        ...
                                                        <div className={cx('shopee_itemcard__promotion_overlay')}>
                                                            <img src={item.imgBackground} alt="" />
                                                        </div>
                                                        <div className={cx('shopee_itemcard__discount-wrapper')}>
                                                            <span aria-label="promotion"></span>
                                                            <span className={cx('shopee_itemcard__discount')}>
                                                                {`-${item.discount}%`}
                                                            </span>
                                                        </div>
                                                        {item.liked && (
                                                            <div className={cx('shopee_itemcard-flag_container')}>
                                                                <div className={cx('shopee_itemcard-flag_wrapper')}>
                                                                    <div
                                                                        className={cx('shopee_itemcard-flag')}
                                                                        style={{
                                                                            backgroundImage:
                                                        ...
                                                        <div className={cx('shopee_itemcard__badge')}>
                                                            <div className={cx('shopee_itemcard-badge-ad')}>Ad</div>
                                                        </div>
                                                    </div>
                                                    <div className={cx('shopee_itemcard__info')}>
                                                        <div className={cx('shopee_itemcard')}>
                                                            <div className={cx('shopee_itemcard-name-wrapper')}>
                                                                {item.name}
                                                            </div>
                                                        </div>
                                                        <div className={cx('mb-2', 'shopee_itemcard-discount-wrapper')}>
                                                            <div
                                                                className={cx(
                                                                    'shopee_itemcard__promotion_label-wrapper',
                                                                )}
                                                            >
                                                                <div className={cx('shopee_itemcard__promotion_label')}>
                                                                    {item.discountPrime && (
                                                                        <div className={cx('nt-medium')}>
                                                                            <svg
                                                                                viewBox="-0.5 -0.5 4 16"
                                                                                className={cx('svg-wrapper-left')}
                                                                            >
                                                                                <path
                                                                            ...
                                                                            <svg
                                                                                viewBox="-0.5 -0.5 4 16"
                                                                                className={cx('svg-wrapper-right')}
                                                                            >
                                                                                <path
                                                                                    d="M4 0h-3q-1 0 -1 1a1.2 1.5 0 0 1 0 3v0.333a1.2 1.5 0 0 1 0 3v0.333a1.2 1.5 0 0 1 0 3v0.333a1.2 1.5 0 0 1 0 3q0 1 1 1h3"
                                                                                    strokeWidth="1"
                                                        ...
                                                        <div className={cx('shopee_itemcard__promotion-price-wrapper')}>
                                                            <div className={cx('shopee_itemcard__promotion')}>
                                                                <div
                                                                    className={cx(
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <span className={cx('text-xs')}>₫</span>
            ...
            <div>
                <div className={cx('section-recomend-products')}>
                    ...
                    <div className={cx('stardust-tabs-panels')}>
                        <section className={cx('stardust-tabs-panels__panel')}>{panelsWrapper}</section>
                    </div>
                </div>
            </div>
        </div>
